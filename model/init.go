...
func (db *DataBase) Init() {
	...
	DB.Self.AutoMigrate(&UserModel{}, &UserAuth{}, &TagModel{}, &ArticleModel{}, &ArticleTagModel{},
		&CategoryModel{}, &CarouseModel{}, &ThumbnailModel{}, &AnnexModel{}, &ArticleAnnexModel{},
		&CommentModel{}, &ArticleHeartModel{}, &CommentHeartModel{})
	InsertAdminUser()
}
...
func OpenDB(username, password, addr, dbname string) *gorm.DB {
	conf := fmt.Sprintf("%s:%s@tcp(%s)/%s?charset=utf8mb4&parseTime=%t&loc=%s", username, password, addr, dbname, true, "Local")
